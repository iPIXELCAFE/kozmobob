...
module.exports = async (req, res) => {
  ...
  try {
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: product === 'baby-star' ? 'https://kozmobob.com/sky?star=success' : 'https://kozmobob.com/?payment=success&product=' + product,
      cancel_url:  product === 'baby-star' ? 'https://kozmobob.com/sky' : 'https://kozmobob.com/?payment=cancelled',
    });
