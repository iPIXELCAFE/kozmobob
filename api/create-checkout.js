...
const PRICES = {
  ...
  'billboard-community': { amountPerHour: 2500,  name: 'Community Billboard' },
  'billboard-premium':   { amountPerHour: 9900,  name: 'Premium Billboard' },
...
module.exports = async (req, res) => {
  ...
  /* Dynamic billboard pricing: $25/hr community, $99/hr premium, +$9.99 priority */
