...
module.exports = async function handler(req, res) {
  ...
  if (cleanMode === 'tarot') {
    ...
    systemPrompt = [
      ...
      'GOOD (write like this): "You keep starting things because the starting feels like proof you are capable. Finishing is where that proof gets tested."',
      'BAD: "Fascination with new beginnings often overshadows the drudgery of completion, a typical pitfall of restless curiosity."',
      'GOOD: "Starting is easy to be good at. Finishing is where you find out if the idea was actually worth anything."',
      'See the difference? Good is direct, specific, makes a real claim. Bad is personality-profiling filler.',
      '',
      'RULES:',
